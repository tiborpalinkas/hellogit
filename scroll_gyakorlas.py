...
st = Pmw.ScrolledText(fen, labelpos = N, label_text = "A ScrolledText widget demója",
						...
						label_pady = 5, text_font = "Helvetica 11 normal", text_bg = "ivory",
						text_padx = 10, text_pady = 10, text_wrap = "none", borderframe = 1,
						borderframe_borderwidth = 3, borderframe_relief = SOLID,
						usehullsize = 1, hull_width = 370, hull_height = 240)
...
title = """A róka és a holló
írta Jean de la Fontain, francia szerző
\n"""
author = """
Jean de la Fontain
